...
import {SpotifyPlaylistSourceItemShort, SpotifyPlaylistSourceItemFull} from '@app/state/search/types';
...
export function* fetchPlaylistDetails(playlist: SpotifyPlaylistSourceItemShort): any {
  ...
  const fullPlaylist: SpotifyApi.PlaylistObjectFull = yield spotifyService.api
    .getPlaylist(playlist.id, accessToken);
