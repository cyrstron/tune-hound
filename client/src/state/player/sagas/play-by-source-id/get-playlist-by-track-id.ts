...
export function* getPlaylistByTrackId(id: string | number, source: SearchSource) {
  if (source === 'spotify') {
    ...
    const track: SpotifyApi.TrackObjectFull = yield spotifyService.api.getTrack(id as string, accessToken);
