  ...
  render() {
    ...
    return (
      <>
        ...
        <button onClick={this.onToggleAdvance}>Advanced {isAdvanced ? '⇑' : '⇓'}</button>
        {isAdvanced && (
          <div>
            <label>
              Artist:
              <input type="text" onChange={this.onAdvancedChange} value={artist} name="artist" />
            </label>
            <br />
            <label>
              Album:
              <input type="text" onChange={this.onAdvancedChange} value={album} name="album" />
            </label>
            <br />
            <label>
              Label:
              <input type="text" onChange={this.onAdvancedChange} value={label} name="label" />
            </label>
            <br />
            Duration{' '}
            <label>
