...
import { DeezerSourceItemShort, DeezerSourceItemFull } from '@app/features/search/search/types';
...
export function* fetchDeezerDetails(deezerItem: DeezerSourceItemShort): any {
