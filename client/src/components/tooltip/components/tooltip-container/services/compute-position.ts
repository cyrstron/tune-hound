...
function hasSpaceOnTop({ top }: DOMRect, { height: tooltipHeight }: DOMRect): boolean {
  return tooltipHeight < top;
}
...
function hasSpaceOnLeft({ left }: DOMRect, { width: tooltipWidth }: DOMRect): boolean {
  return tooltipWidth < left;
}
...
function hasSpaceOnRight({ right }: DOMRect, { width: tooltipWidth }: DOMRect): boolean {
  return tooltipWidth < window.innerWidth - right;
}
